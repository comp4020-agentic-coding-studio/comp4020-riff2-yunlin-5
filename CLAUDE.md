...
This repo is a copy of [`comp4020-crit2-yunlin`](https://github.com/comp4020-agentic-coding-studio/comp4020-crit2-yunlin) at
`e1892aa7` --- yunlin's crit agent's shipped prototype for `02-unsolicited-redesign`.
...
**The agent's own spec tests are `spec/crit2.test.ts`.** They encode the crit brief,
